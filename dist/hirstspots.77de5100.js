...
/** @class */
function () {
  function Grid(rows, cols, radius, margin, distBetweenSpots, backgroundColor) {
    var _this = this;
    ...
    d3.selectAll("#controls input[type=range]").on("input", function () {
      return _this.updateChart();
    });
  }

  Grid.prototype.incrementCoordinate = function (current, i) {
    if (i == 0) {
  ...
  Grid.prototype.generateCoordinates = function () {
    var coordinates = [];
    var _a = [0, 0],
        x = _a[0],
        y = _a[1];
  ...
  Grid.prototype.render = function () {
    ...
    var bg = svg.append("rect").attr("width", "100%").attr("height", "100%").attr("fill", this.backgroundColor);
    this.g = svg.append("g");
    this.g.selectAll("circle").data(coordinates).join("circle").attr("cx", function (_a) {
      var x = _a[0];
      return x;
    }).attr("cy", function (_a) {
      var y = _a[1];
      return y;
    }).attr("r", this.radius).attr("fill", function (d, i) {
      return d3.interpolateRainbow(i / coordinates.length);
    });
    return svg.node();
  };

  Grid.prototype.updateChart = function () {
    var target = d3.event.target;
    this[target.id] = +target.value;
    var coordinates = this.generateCoordinates();
    var circle = this.g.selectAll("circle").data(coordinates);
    circle.exit().remove();
    circle.enter().append("circle").attr("cx", function (_a) {
      var x = _a[0];
      return x;
    }).attr("cy", function (_a) {
      var y = _a[1];
...
exports.Grid = Grid;
},{"d3":"node_modules/d3/index.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
},{"d3":"node_modules/d3/index.js","./models/grid":"models/grid.ts"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/hirstspots.77de5100.js.map